  ...
  const LoginPage = () => {
    ...
    const handleLogin = async () => {
      ...
      try {
        ...
        console.error('Login failed:', error.response?.data?.error ?? 'Invalid email or password');
        const apiErrorMessage = error.response?.data?.error ?? "Invalid Email or password";
